...
<template>
  <section class="text-white text-left w-[80dvw] md:w-1/2 pb-5">
    ...
    <p class="indent-5">
      Need to find a way to progressivly style text based on a scroll position
    </p>
    <h2 class="text-xl text-orange-300">
      Logic:
    </h2>
    <p class="indent-5">
      Now that we have the css for animation-timeline and animation-range we can scrap all the JS implimentations and use these for <Highlight content="animation-range: scroll()" /> and <Highlight content="animation-range: view()" /> to capture and get our progression percentages for animations frames
    </p>
    <h2 class="text-xl text-orange-300">
      Source:
    </h2>
    <p class="indent-5">
      Kevin Powell https://www.youtube.com/watch?v=d10GaL6F-lA
    </p>
  </section>
  ...
  <section class="min-h-[80vh] flex flex-col pt-5">
    spacer to enable scroll for scroll toggling
  </section>  
</template>
