...
<template>
  <section class="text-white text-left w-[80dvw] md:w-1/2 pb-5">
    ...
    <p class="indent-5">
      How do they Work: <em>How do paralax image reveal adds even work?</em>
    </p>
    <h2 class="text-xl">
      Details:
    </h2>
    <p class="indent-5">
      Been seeing these scroll reveal paralax image adds that are z-index'd underneath the content and revealed on scroll
    </p>
    <h2 class="text-xl">
      Logic:
    </h2>
  ...
  <section class="w-1/2 flex flex-col">
    ...
    <article 
      ref="ad_1" 
      class="h-24 w-full bg-fix bg-[url('/airship.jpg')]"
    ></article>
